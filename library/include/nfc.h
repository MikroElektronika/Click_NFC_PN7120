...
/**
 * @file nfc.h
 * @brief API layer for NXP 7120 NFC chip
 *
 *  @date 20 Feb 2016
 *  @author Richard Lowe
 ...
 * @return int - 0 success, -1 error
 */
int nfc_start_discovery
(
        uint8_t *p_tech_tab,
        uint8_t tech_tab_size
);
 ...
 * @param p_rf_intf
 */
void nfc_wait_for_discovery_notification
(
        nfc_interface_t *p_rf_intf
);
