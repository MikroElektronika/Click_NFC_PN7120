...
*******************************************************************************/
static uint8_t T4T_NDEF_EMU_APP_SELECT[] =
{
    0x00, 0xA4, 0x04, 0x00, 0x07, 0xD2, 0x76, 0x00, 0x00, 0x85, 0x01, 0x01
};

static uint8_t T4T_NDEF_EMU_CC[] =
{
    0x00, 0x0F, 0x20, 0x00, 0xFF, 0x00, 0xFF, 0x04, 0x06, 0xE1, 0x04, 0x00,
    0xFF, 0x00, 0xFF
};

static uint8_t T4T_NDEF_EMU_CC_SELECT[] =
{
    0x00, 0xA4, 0x00, 0x0C, 0x02, 0xE1, 0x03
};

static uint8_t T4T_NDEF_EMU_NDEF_SELECT[] =
{
    0x00, 0xA4, 0x00, 0x0C, 0x02, 0xE1, 0x04
};

static uint8_t T4T_NDEF_EMU_READ[] = {0x00, 0xB0};
static uint8_t T4T_NDEF_EMU_OK[] = {0x90, 0x00};
static uint8_t T4T_NDEF_EMU_NOK[] = {0x6A, 0x82};
